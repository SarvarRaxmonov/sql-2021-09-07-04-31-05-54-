...
#photo_path = 'images/{}.jpg'.format(calendar['id'])
        ...
        update.message.reply_html('{} \n {} \n\n\n<b>BOMDOD</b> | {}\n\n<b>PESHIN</b> | {}\n\n<b>ASR</b> | {}\n\n<b>SHOM</b> | {}\n \n<b>XUFTON</b> | {}\n \n'.format(
            region['name'],calendar['r_date'], calendar['fajr'], calendar['maghrib'], calendar['asr'], calendar['shom'], calendar['xufton']))
    except Exception as e:
        print('Error ', str(e))
...
#photo_path = 'images/{}.jpg'.format(calendar['id'])
        ...
        update.message.reply_html( caption=message, parse_mode='HTML',
                                   reply_markup=main_buttons)
    except Exception as e:
        print('Error ', str(e))
...
#photo_path = 'images/table/region_{}.jpg'.format(region['id'])
        ...
        update.message.reply_html("""(photo=open(photo_path, 'rb')""", caption=message, parse_mode='HTML',
                                   reply_markup=main_buttons)
    except Exception as e:
        print('Error ', str(e))
...
def select_dua(update, context):
    ...
    update.message.reply_html("{}" "{}".format(saharlik, iftorlik))
